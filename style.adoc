...
* When using a list inside a list, limit the structure to at most n levels of depth to maintain clarity and readability. If you find yourself needing more levels, consider reorganizing the content to make it easier for users to navigate and understand.
