...
|1. Analyze the wellness attributes of your storage system in one of two ways, depending on what you want to analyze: Either select the wellness attribute widget on the dashboard or select View All to view the entire list of wellness attributes.
|1. You’ve got two ways to analyze your system’s wellness attributes: Just select the wellness attribute widget on the dashboard. Or, if you’d rather see the whole list of wellness attributes in one view, select View All.
|1. Select the wellness attribute widget on the dashboard or select View All to view the list of all actions and risks.

|1. When the Setup wizard starts, follow the instructions in the wizard to set up the node and join it to the cluster. The following steps walk you through the steps in the wizard.
|1. The Setup wizard appears (almost like magic), to guide you through the simple process of setting up the node and joining it to the cluster.
|1. Follow the instructions in the Setup wizard to set up the node and join it to the cluster.
...
* IMPORTANT
+
Use IMPORTANT only to indicate instructions that users must follow to avoid equipment damage, a system crash, or data loss.
* CAUTION
+
...
* WARNING
+
Use WARNING only in hardware content and only to warn users about conditions or procedures that can result in death or severe personal injury.
