...
=== Tabbed block
If you're explaining a task in multiple flavors or code in multiple languages, you might want to use a tabbed block. Tabbed blocks are a NetApp custom AsciiDoc extension, and supports other AsciiDoc syntax within each tab. 

Here's syntax for a basic tabbed block: 
...
To specify code examples in different languages: 
...
.Java
--
This is how to print out a String in Java.
...
.JavaScript
--
This is how to print out a String in JavaScript.
...
.Python
--
This is how to print out a String in Python.
