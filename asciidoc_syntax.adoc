...
+
 include::https://raw.githubusercontent.com/NetAppDocs/<reponame>/master/_include/<filename>.adoc[]
+
For example:
+
 include::https://raw.githubusercontent.com/NetAppDocs/cloud-tiering/master/_include/s3regions.adoc[]
